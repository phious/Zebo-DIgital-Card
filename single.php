			...
			<?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
					<div class="row">
						...
						<div class="col-md-7 product-single">
							...
							<div class="p-price">Birr <?php echo $prodr['price']; ?> - 10,000</div>
					...
					<div class="related-products">
						<h4 class="heading">Related Packages</h4>
						<hr>
						<div class="row">
							 ...
							 ?>
								<div class="sm-item isotope-item">
									<div class="product">
										...
										<div class="product-price">Birr <?php echo $relr['price']; ?>.00/-<span></span></div>
									</div>
								</div>
							<?php } ?>
							</div>
