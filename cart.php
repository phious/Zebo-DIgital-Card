				...
				$total = 0;
				 ...
				 ?>
					<tr>
						...
						<td>
							<span class="amount">Birr<?php echo $cartr['price']; ?>.00/-</span>					
						</td>
						<td>
							<div class="quantity"><?php echo $value['quantity']; ?></div>
						</td>
						<td>
							<span class="amount">Birr<?php echo ($cartr['price']*$value['quantity']); ?>.00/-</span>					
						</td>
					</tr>
				<?php 
						...
						<td colspan="6" class="actions">
							...
							<div class="col-md-6">
								<div class="cart-btn">
									...
									<a href="checkout.php" class="button btn-md" >Order now</a>
								</div>
							</div>
						</td>
					</tr>
				...
				<div class="col-md-6 push-md-6 no-padding">
					...
					<table class="table table-bordered col-md-6">
						<tbody>
							<tr>
								<th>Cart Subtotal</th>
								<td><span class="amount">Birr <?php echo $total; ?>.00 - 10000-</span></td>
							</tr>
							<tr>
							...
							<tr>
								<th>Order Total</th>
								<td><strong><span class="amount">Birr <?php echo $total; ?>.00 - 10000-</span></strong> </td>
							</tr>
						</tbody>
					</table>
				</div>
